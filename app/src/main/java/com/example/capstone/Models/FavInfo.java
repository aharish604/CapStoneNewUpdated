...
public class FavInfo implements Parcelable {
    ...
    public static final Creator<FavInfo> CREATOR = new Creator<FavInfo>() {
        @Override
        public FavInfo createFromParcel(Parcel in) {
            return new FavInfo(in);
        }

        @Override
        public FavInfo[] newArray(int size) {
            return new FavInfo[size];
        }
    };
